  ...
  return (
    <>
      <button
        ...
        disabled={loading}
        className={cn(
          "inline-flex items-center justify-center rounded-full bg-brand-orange px-10 py-4 text-base sm:text-lg font-bold text-brand-purple tracking-wide shadow-[0_10px_30px_rgba(242,117,33,0.28)] transition-all duration-300 hover:scale-[1.04] hover:bg-brand-orange/90 hover:shadow-[0_18px_40px_rgba(242,117,33,0.38)] active:scale-[0.98] disabled:opacity-60 relative overflow-hidden",
          className
        )}
      >
